...
from flask import jsonify, send_from_directory, flash, request
import os
...
def create_trusted_leading_brands():
    ...
    try:
        ...
        if (
            _company_name_tb01
            and _company_information_tb01
            and _economic_sector_tb01
            and _sector_tb01
            and _industry_tb01
            and _brand_image_tb01
            ...
            list_of_db_data = (
                _company_name_tb01,
                _company_information_tb01,
                _economic_sector_tb01,
                _sector_tb01,
                _industry_tb01,
                _brand_image_tb01,
            )
...
def get_all_trusted_leading_brands():
    ...
    try:
        ...
        pymysql_cursor.execute(
            "SELECT id_tb01, company_name_tb01, company_information_tb01, economic_sector_tb01, sector_tb01, industry_tb01, brand_image_tb01 FROM trusted_leading_brands_tb01"
        )
...
def get_one_trusted_leading_brands(id_tb01):
    ...
    try:
        ...
        pymysql_cursor = create_mysql_connection.cursor(pymysql.cursors.DictCursor)
        pymysql_cursor.execute(
            f"SELECT id_tb01, company_name_tb01, company_information_tb01, economic_sector_tb01, sector_tb01, industry_tb01, brand_image_tb01 FROM trusted_leading_brands_tb01 WHERE id_tb01 ={id_tb01}"
        )
...
def delete_one_trusted_leading_brand(id_tb01):
    ...
    try:
        ...
        pymysql_cursor = create_mysql_connection.cursor()
        pymysql_cursor.execute(
            "DELETE FROM trusted_leading_brands_tb01 WHERE id_tb01 =%s", (id_tb01,)
        )
        create_mysql_connection.commit()
        http_response = jsonify(
            f"Trusted leading brand with ID: {id_tb01} deleted successfully!"
        )
        http_response.status_code = 200
        return http_response
